...
struct LargeListWidgetEntry: TimelineEntry {
    var date: Date
    let lessons: [WidgetDataManager.LessonWithTitle] //TODO: мда блять, интересненькая имплементация структуры, ебучий вонючий, ну я хуй знает как это архитектурно правильно сделать, один хуй используется только тут
}
